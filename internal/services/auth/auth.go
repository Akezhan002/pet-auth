...
import (
	"context"
	"errors"
	"example.com/pet_auth/internal/domain/models"
	"example.com/pet_auth/internal/lib/jwt"
	"example.com/pet_auth/internal/lib/logger/sl"
...
func (a *Auth) RegisterNewUser(ctx context.Context, email string, password string) (int64, error) {
	...
	log := a.log.With(
		slog.String("op", op),
		slog.String("email", email), //todo в логах так лучше не хранить
	)
...
func (a *Auth) IsAdmin(ctx context.Context, userID int64) (bool, error) {
	...
	log.Info("checked if use is admin", slog.Bool("is_admin", IsAdmin))
